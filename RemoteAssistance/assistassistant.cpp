...
void AssistAssistant::give_help()
{
    ...
    //connect(g_edit,&QLineEdit::textChanged,this,&AssistAssistant::judgeCord);
    ...
    DPushButton *link_button = new DPushButton(this);
    link_button->setText(QObject::tr("连接"));

    connect(link_button,&DToolButton::clicked,this,&AssistAssistant::give_one);
    ...
    g_layout->addSpacing(10);
    g_layout->addWidget(link_button,0,Qt::AlignHCenter);
...
//----------------获取输入验证码　连接－－－－－－－－//
//void AssistAssistant::judgeCord()
//{   qDebug()<<"77777777";
//    //str_num1 = nullptr;
//    str_num1 = g_edit->text();
//    qDebug()<<g_edit->text();
...
//        connect(g_button,&DPushButton::clicked,this,&AssistAssistant::give_one);
//    }
//}
